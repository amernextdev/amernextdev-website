...
export const siteChrome = {
    ...
    inject() {
        ...
        if (mainContent) {
            mainContent.insertAdjacentHTML('beforebegin', layoutRegistry.mobileNavigationMarkup);
        } else {
            documentBody.insertAdjacentHTML('afterbegin', layoutRegistry.mobileNavigationMarkup);
        }
    },
    init() {
        // -- تنفيذ الحقن --
        ...
        function syncActiveNavigationLink() {
            ...
            const currentFileName = pageData.currentPageData
        .fileName;
